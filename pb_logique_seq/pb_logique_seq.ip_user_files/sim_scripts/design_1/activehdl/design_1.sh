...
#
# Generated by Vivado on Sat May 21 16:55:28 -0400 2022
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/temp_vivado/APP2/UdeS_S4APP2/pb_logique_seq/pb_logique_seq.cache/compile_simlib/activehdl"
  fi
